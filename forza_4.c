...
int main(int argc, char** argv){
    ...
    for(;;){
        printf("Giocatore 1 inserisci numero di colonna compresa fra 1 e 6:\n");
        int n;
        int max=scanf("%d", &n);
        while(n>=7 || n<0){
            printf("Numero colonna non valida, inserire un numero di colonna compreso tra 1 e 6\n");
            max=scanf("%d", &n);
        }
        n--;
        ...
        stampa(forza);
        printf("Giocatore 2 inserisci numero di colonna compresa fra 1 e 6:\n");
        max=scanf("%d", &n);
        while(n>=7 || n<0){
            printf("Numero colonna non valida, inserire un numero di colonna compreso tra 1 e 6\n");
            max=scanf("%d", &n);
